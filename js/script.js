...
var orientation_left= { // Auxilities for check orientation
    top_left:  Number(),
    top_right:  Number(),
    bottom_left:  Number(),
    bottom_right:  Number()
...
function click_top_left() {
    ...
    if (top_left_correct === false || top_right_correct === false || bottom_right_correct === false || bottom_left_correct === false){
        if (!((top_right.style.marginBottom == "3%") || (bottom_right.style.marginTop == "3%") || (bottom_left.style.marginTop == "3%"))) {
...
function click_top_right() {
    if (top_left_correct === false || top_right_correct === false || bottom_right_correct === false || bottom_left_correct === false){
        if (!((top_left.style.marginBottom == "3%") || (bottom_right.style.marginTop == "3%") || (bottom_left.style.marginTop == "3%"))) {
...
function click_bottom_right() {
    if (top_left_correct === false || top_right_correct === false || bottom_right_correct === false || bottom_left_correct === false){
        if (!((top_right.style.marginBottom == "3%") || (top_left.style.marginBottom == "3%") || (bottom_left.style.marginTop == "3%"))) {
...
function click_bottom_left() {
    if (top_left_correct === false || top_right_correct === false || bottom_right_correct === false || bottom_left_correct === false){
        if (!((top_right.style.marginBottom == "3%") || (bottom_right.style.marginTop == "3%") || (top_left.style.marginBottom == "3%"))) {
...
// Turn Img
function check_which_turn() { //Return the img for turn
...
function turn_left() {
    ...
    if (img === top_left) {
        ...
        var result = (orientation_left["top_left"] + orientation_right["top_left"])/180;
        ...
        if (img === top_right) {
            ...
            var result = (orientation_left["top_right"] + orientation_right["top_right"])/180;
            if (((result % 2) == 1) || (((result % 2) == -1))){
            ...
            if (img === bottom_right) {
                ...
                var result = (orientation_left["bottom_right"] + orientation_right["bottom_right"])/180;
                if (((result % 2) == 1) || (((result % 2) == -1))){
                ...
                if (img === bottom_left) {
                    ...
                    var result = (orientation_left["bottom_left"] + orientation_right["bottom_left"])/180;
                    if (((result % 2) == 1) || (((result % 2) == -1))){
...
// Show About
function show_about(){
    about.style += "position: relative; padding-top: 1.2%; padding-bottom: 0.5%; ";  
    about.innerHTML += "<div class='about-content content-container'> <img class='about-img content-container' src='img/mozila/logo.png'> <p class='about-text content-container'>Mozilla Firefox  is a free and open source web browser which is made by the Mozilla Foundation and its subsidiary, the Mozilla Corporation. It works on common operating systems, such as Windows, macOS, Linux and Android. With Firefox, browsing features can be added or removed and users can customize Firefox to fit their needs. This was done to make Firefox safe and simple to use. See more <a class='about-link' href='https://www.mozilla.org/en-US/about/'>Mozila Firefox</a>.</p> </div>" ;
